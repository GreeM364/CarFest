...
import {visibilityPopup} from "../../service/animations";
...
export class MenuItemComponent implements OnInit {
  ...
  popupTop = 42;
  isActiveRoute = false;
  constructor(public menuService: MenuService, private router: Router, private el: ElementRef, private renderer: Renderer2) { }
